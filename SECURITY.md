...
If you discover a security vulnerability in LindemannRock Plugin Base, please report it privately. **Do not open a public GitHub issue** — public disclosure before a fix is available puts other users at risk.

### Preferred: GitHub private advisory

[Open a private security advisory](https://github.com/LindemannRock/craft-plugin-base/security/advisories/new). This routes the report directly to maintainers with no public visibility.
...
- Vulnerabilities in shared helpers, traits, or templates that propagate to consumer plugins
