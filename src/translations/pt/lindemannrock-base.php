...
return [
    ...
    'No suitable cross-request cache is available. Cache data is recomputed as needed.' => 'Não está disponível uma cache adequada entre pedidos. Os dados da cache são recalculados conforme necessário.',
    'Active' => 'Ativo',
