...
return [
    ...
    'Plugin name cannot contain HTML or control characters.' => 'Der Plugin-Name darf kein HTML und keine Steuerzeichen enthalten.',
    ...
    '{feature} requires {plugin} {edition}' => '{feature} erfordert {plugin} {edition}',
    'View {plugin} {edition} in the Plugin Store' => '{plugin} {edition} im Plug-in-Store anzeigen',
    'Export' => 'Exportieren',
    ...
    'error' => 'Fehler',
    'Found {count, number} {count, plural, =1{error} other{errors}}' => '{count, plural, =1{Es wurde {count, number} Fehler gefunden} other{Es wurden {count, number} Fehler gefunden}}',
